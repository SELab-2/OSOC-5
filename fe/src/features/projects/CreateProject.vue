<template>
  ...
  >
    <div class="row wrap justify-center items-baseline content-start">
      <div
        class="projectcol basiccol items-center col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3"
      >
      ...
      <div
        class="projectcol coachescol items-center col-xs-12 col-sm-6 col-md-5 col-lg-3 col-xl-3"
      >
      ...
      <div
        class="projectcol rolescol items-center col-xs-12 col-sm-12 col-md-8 col-lg-6 col-xl-6"
      >
        <div class="text-bold text-h4">⠀⠀</div>
    ...
    return {
      ...
      new_role_confirm() {
        if (new_role.value && new_role.value.length > 0) {
          rows_rols.value = [
            ...rows_rols.value,
            { name: new_role.value, amount: 0, comment: '' },
          ]
