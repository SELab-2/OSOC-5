    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(
                    max_length=255, verbose_name='last name')),
                ('call_name', models.CharField(blank=True,
                 max_length=255, null=True, verbose_name='call name')),
                ('email', models.EmailField(max_length=255,
                 unique=True, verbose_name='email address')),
                ...
                ('language', models.CharField(choices=[('0', 'Dutch'), ('1', 'English'), ('2', 'French'), (
                    '3', 'German'), ('4', 'Other')], default='0', max_length=1, verbose_name='language')),
                ('extra_info', models.TextField(
                    blank=True, null=True, verbose_name='extra info')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('suggestion', models.CharField(choices=[
                 ('0', 'Yes'), ('1', 'No'), ('2', 'Maybe')], max_length=1, verbose_name='suggestion')),
                ('reason', models.TextField(
                    blank=True, null=True, verbose_name='reason')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='common.skill')),
            ],
        ),
        migrations.CreateModel(
