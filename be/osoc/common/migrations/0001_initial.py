# Generated by Django 3.2.13 on 2022-05-03 11:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('0', 'Applied'), ('1', 'Awaiting project'), ('2', 'Approved'), ('3', 'Contract confirmed'), ('4', 'Contract declined'), ('5', 'Rejected')], default='0', max_length=1, verbose_name='status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final', models.BooleanField(default=False, verbose_name='final decision')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(blank=True, default=django.utils.timezone.now, verbose_name='send date and time')),
                ('info', models.CharField(blank=True, default='', max_length=255, verbose_name='email info')),
                ('receiver', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.student')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coach', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.project')),
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='common.skill')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.student')),
            ],
        ),
        migrations.AddField(
            model_name='project',
