    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coaches', models.ManyToManyField(to='common.coach')),
            ],
        ),
        migrations.CreateModel(
            name='Skill',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coach', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.coach')),
        ...
        migrations.AddField(
            model_name='project',
            name='skills',
            field=models.ManyToManyField(through='common.ProjectNeedsSkills', to='common.skill'),
        ),
        migrations.AddField(
            model_name='coach',
            name='suggestions',
            field=models.ManyToManyField(through='common.Suggestion', to='common.student'),
        ),
        migrations.CreateModel(
